...
#define FFMPEG_CONFIGURATION "--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --sysroot=/data/android-ndk-r6/platforms/android-9/arch-arm --disable-shared --disable-symver --enable-static --enable-stripping --disable-small --enable-version3 --enable-gpl --enable-nonfree --enable-encoders --enable-muxers --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-devices --disable-avdevice --disable-ffprobe --extra-cflags='-DANDROID -fpic -ffunction-sections -funwind-tables -fstack-protector -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -Wno-psabi -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300 -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags='-Wl,--fix-cortex-a8'"
...
#if defined(VPLAYER_NEON)
#define HAVE_ARMV6 1
#define HAVE_ARMV6T2 1
#define HAVE_ARMVFP 1
#define HAVE_VFPV3 1
#define HAVE_NEON 1
#elif defined(VPLAYER_ARMV7)
#define HAVE_ARMV6 1
#define HAVE_ARMV6T2 1
#define HAVE_ARMVFP 1
#define HAVE_VFPV3 1
#define HAVE_NEON 0
#elif defined(VPLAYER_ARMV6VFP)
#define HAVE_ARMV6 1
#define HAVE_ARMV6T2 1
#define HAVE_ARMVFP 1
#define HAVE_VFPV3 0
#define HAVE_NEON 0
#elif defined(VPLAYER_ARMV6)
#define HAVE_ARMV6 1
